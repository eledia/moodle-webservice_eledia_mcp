...
$string['premium_status_active'] = 'Premium aktiviert';
$string['premium_status_active_notice'] = 'Das Premium-Add-on schaltet den vollständigen kuratierten MCP-Tool-Katalog frei. Rohe Moodle-Webservice-Funktionen benötigen weiterhin die separate Einstellung unten.';
$string['premium_status_free'] = 'Free-Version';
$string['premium_status_free_notice'] = 'Die Free-Version stellt nur die MCP-Basis-Tools bereit. Installieren und aktivieren Sie das eLeDia.ai Tutor Premium-Add-on mit dem Feature mcp_tools, um den vollständigen Katalog freizuschalten.';
...
$string['setting_enforce_mcp_service_desc'] = 'Wenn aktiviert (Standard), akzeptiert der MCP-Endpunkt nur Tokens, die zu einem konfigurierten MCP-Dienst gehören. Damit ist die MCP-Dienstliste die Zugriffsgrenze des Endpunkts, nicht nur für die Token-Ausgabe. Nur deaktivieren, wenn Tokens anderer Webservices verwendet werden müssen.';
